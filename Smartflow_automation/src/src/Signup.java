...
public class Signup {
	...
	// WebElement l_namespecialchar =
	// driver.findElement(By.id("m_user_login_last_name"));
	// l_namespecialchar.clear();
	// l_namespecialchar.sendKeys("12345678");
	// // Thread.sleep(2000);
	// driver.findElement(By.xpath("//*[@id=\"new_m_user_login\"]/div[5]/div[1]/div/button")).submit();
	// String l_name_result1 =
	// driver.findElement(By.id("m_user_login_last_name-error")).getText();
	...
	// ------------------------------------------phone number with less then 10
	// digit--------------------------------------//
	...
	// --------------------------------- phone number with more then 10
	// digit----------------------------//
	...
	public void confirm_password() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"new_m_user_login\"]/div[5]/div[1]/div/button")).submit();
		String confirm_pass_expect_msg = driver.findElement(By.id("m_user_login_password_confirmation-error"))
				.getText();
	...
	public void confirm_password_int() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"new_m_user_login\"]/div[5]/div[1]/div/button")).submit();
		String confirm_pass_expect_msg1 = driver.findElement(By.id("m_user_login_password_confirmation-error"))
				.getText();
	...
	public void confirm_password_i() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"new_m_user_login\"]/div[5]/div[1]/div/button")).submit();
		String confirm_pass_expect_msg2 = driver.findElement(By.id("m_user_login_password_confirmation-error"))
				.getText();
